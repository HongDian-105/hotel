            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    <div class="page-heading">
                        <h1>石斑房</h1>
                        <hr class="small">
                        <span class="subheading">Epinephelus coioides</span>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-12">
                    <div class="col-md-3" style="padding-top: 15px">
                        <div class="card text-center" style="border-style:none;background-color:transparent;">
                            <div class="card-body">
                                <img src="img/石斑-2.jpg" width="250" style="border-radius: 50px;">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-9">
                                ...
                                <div class="wpb_wrapper">
                                    <font color="#000000" face="標楷體" size="5">
                                        <table class="table table-hover">
                                            ...
                                            <tr>
                                                <td>　　房型介紹</td>
                                                <td>　16坪(52.9平方公尺)；三特大床 (200x210cm)</td>
                                            </tr>
                                            <tr>
                                                <td>　　客房設備</td>
                        ...
                        <div class="col-md-2" style="padding-top: 20px">
                            <div class="card text-center" style="border-style:none;background-color:transparent;">
                                <div class="card-body">
                                    ...
                                    <br><font style="font-size:18px" color="#888888" face="標楷體">金額 6,600</font>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-2" style="padding-top: 20px">
                            <div class="card text-center" style="border-style:none;background-color:transparent;">
                                <div class="card-body">
                                    ...
                                    <i class="fa fa-male fa-1x" style="color:#800000"></i><i class="fa fa-female fa-1x" style="color:#800000"></i>
                                    <br><font style="font-size:18px" color="#888888" face="標楷體">六人房</font>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-2" style="padding-top: 20px">
                        ...
                        <div class="col-md-12">
                            <div class="col-md-6">
                                <div class="card" style="border-style:none;background-color:transparent;text-align:center;">
                                    <div class="card-body">
                                        <a href="{{url('/room2')}}"><font style="font-size:20px" color="gray" face="標楷體"><i class="fa fa-arrow-left fa-1x" style="color:gray"></i>土魠房</font></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="card" style="border-style:none;background-color:transparent;text-align:center;">
                                    <div class="card-body">
                                        <a href="{{url('/room4')}}"><font style="font-size:20px" color="gray" face="標楷體">紅魽房<i class="fa fa-arrow-right fa-1x" style="color:gray"></i></font></a>
                                    </div>
                                </div>
                            </div>
                        </div>
