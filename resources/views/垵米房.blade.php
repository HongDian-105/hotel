            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    <div class="page-heading">
                        <h1>垵米房</h1>
                        <hr class="small">
                        <span class="subheading">Gerres oyena</span>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-12">
                    <div class="col-md-3" style="padding-top: 15px">
                        <div class="card text-center" style="border-style:none;background-color:transparent;">
                            <div class="card-body">
                                <img src="img/垵米.jpg" width="250" style="border-radius: 50px;">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-9">
                ...
                <div class="row">
                    <div class="col-md-12" style="padding-top: 30px">
                        <div class="owl-carousel owl-theme">
                            <div class="item" style="width:600px"><img src="img/room/垵米/1.jpg"></div>
                            <div class="item" style="width:600px"><img src="img/room/垵米/2.jpg"></div>
                        ...
                        <div class="col-md-12">
                            <div class="col-md-6">
                                <div class="card" style="border-style:none;background-color:transparent;text-align:center;">
                                    <div class="card-body">
                                        <a href="{{url('/room5')}}"><font style="font-size:20px" color="gray" face="標楷體"><i class="fa fa-arrow-left fa-1x" style="color:gray"></i>花枝丸房</font></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
