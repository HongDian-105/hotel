            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    <div class="page-heading">
                        <h1>土魠房</h1>
                        <hr class="small">
                        <span class="subheading">Scomberomorus commerson</span>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-12">
                    <div class="col-md-3" style="padding-top: 15px">
                        <div class="card text-center" style="border-style:none;background-color:transparent;">
                            <div class="card-body">
                                <img src="img/土魠.jpg" width="250" style="border-radius: 50px;">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-9">
                        ...
                        <div class="col-md-2" style="padding-top: 20px">
                            <div class="card text-center" style="border-style:none;background-color:transparent;">
                                <div class="card-body">
                                    ...
                                    <br><font style="font-size:18px" color="#888888" face="標楷體">金額 4,800</font>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-2" style="padding-top: 20px">
                ...
                <div class="row">
                    <div class="col-md-12" style="padding-top: 30px">
                        <div class="owl-carousel owl-theme">
                            <div class="item" style="width:600px"><img src="img/room/土魠/1.jpg"></div>
                            <div class="item" style="width:600px"><img src="img/room/土魠/2.jpg"></div>
                            <div class="item" style="width:600px"><img src="img/room/土魠/3.jpg"></div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="col-md-6">
                                <div class="card" style="border-style:none;background-color:transparent;text-align:center;">
                                    <div class="card-body">
                                        <a href="{{url('/room3')}}"><font style="font-size:20px" color="gray" face="標楷體">石斑房<i class="fa fa-arrow-right fa-1x" style="color:gray"></i></font></a>
                                    </div>
                                </div>
                            </div>
                        </div>
