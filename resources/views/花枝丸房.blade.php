            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    <div class="page-heading">
                        <h1>花枝丸房</h1>
                        <hr class="small">
                        <span class="subheading">Huazhiwan</span>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-12">
                    <div class="col-md-3" style="padding-top: 15px">
                        <div class="card text-center" style="border-style:none;background-color:transparent;">
                            <div class="card-body">
                                <img src="img/花枝丸.jpg" width="250" style="border-radius: 50px;">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-9">
                ...
                <div class="row">
                    <div class="col-md-12" style="padding-top: 30px">
                        <div class="owl-carousel owl-theme">
                            <div class="item" style="width:600px"><img src="img/room/花枝丸/1.jpg"></div>
                            <div class="item" style="width:600px"><img src="img/room/花枝丸/2.jpg"></div>
                            <div class="item" style="width:600px"><img src="img/room/花枝丸/3.jpg"></div>
                            <div class="item" style="width:600px"><img src="img/room/花枝丸/4.jpg"></div>
                            <div class="item" style="width:600px"><img src="img/room/花枝丸/5.jpg"></div>
                            <div class="item" style="width:600px"><img src="img/room/花枝丸/6.jpg"></div>
                        </div>
                    </div>
                </div>
                <div class="col-md-12" style="padding-top:30px">
                        ...
                        <div class="col-md-12">
                            <div class="col-md-6">
                                <div class="card" style="border-style:none;background-color:transparent;text-align:center;">
                                    <div class="card-body">
                                        <a href="{{url('/room4')}}"><font style="font-size:20px" color="gray" face="標楷體"><i class="fa fa-arrow-left fa-1x" style="color:gray"></i>紅魽房</font></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
